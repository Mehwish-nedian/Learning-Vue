...
import {useRouter} from 'vue-router'; // For replacement of this.$router.push()

export default {
  setup() {
    const addProduct = inject('addProduct');
    /* For routing programmatically, in option API we use this.$router.push('path')
      but here this cannot be used instead useRouter hook is used
    */
